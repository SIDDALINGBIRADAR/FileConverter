export default function PrivacyPolicy() {
  return (
    <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
      <p>Effective Date: Monday 1 dec 2023</p>
      <p>
        At conveter, we are committed to safeguarding your privacy. This Privacy
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          Siddalingbiradar10@gmail.com.
        </p>
      </div>

      <p>
        By using Converter, you agree to the practices outlined in this Privacy
