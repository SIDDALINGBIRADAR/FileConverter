export default function About() {
  return (
    <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
      <p>
        Introducing , the ultimate multimedia conversion powerhouse that
      ...
      <div className="space-y-2">
        ...
        <p>
          Access Converter from any device with an internet connection. Whether
